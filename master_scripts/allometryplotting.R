...
####png 
# png(filename = "master_scripts/manuscript_figs/png/height.png", width = 11, height = 8.5, units = "in", res= 400)
...
# dev.off()
# 
# png(filename = "master_scripts/manuscript_figs/png/diam.png", width = 11, height = 8.5, units = "in", res= 400)
# par(mar=c(5,5,2,2), cex.axis=1.5,cex.lab=1.75 ,las=1)
# 
# plot(diameter.mean ~ Date, data=diam_agg, type='n',ylab=expression(Diameter~~(mm)),ylim=c(0,17), 
#      axes = FALSE, xlab="",xlim=xlimdays)
...
# dev.off()
# 
# png(filename = "master_scripts/manuscript_figs/png/leaf.png", width = 11, height = 8.5, units = "in", res= 400)
# par(mar=c(5,5,2,2), cex.axis=1.5,cex.lab=1.75 ,las=1)
# 
# plot(canopysqm.mean ~ Date, data=leafarea_time, axes=FALSE,xlab="", ylab=LAm2,
#      type='n', ylim=c(0,.7),xlim=xlimdays)
