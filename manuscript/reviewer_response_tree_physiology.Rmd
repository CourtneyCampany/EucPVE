...
\
*Response*: We agree with the reviewers point here. We have re-worded the first principle question to more accurately address what we were able to test with the presented data. 
...
\
*Response*: We have clarified in “Leaf, root and soil chemistry” that samples were over dried at 60&degC to a constant mass and ball milled for analysis.We have also added the pore size, drying time and mill type to explanation of soil processing.
...
\
*Response*: see response to comment #7.  Our approach uses the residual C from mass balance to all other potential C losses.
