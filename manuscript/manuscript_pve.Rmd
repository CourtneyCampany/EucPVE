...
\
We used the model to test the hypothesis that the effects of belowground sink limitation on rates of leaf *A*~n~ were sufficient to accurately predict overall seedling biomass production after 120 days.  Cumulative net leaf C gain for each treatment was equal to the sum of each value of *P* over 120 days and final seedling C was assumed to equal half of the final dry mass for observed seedlings. We then compared seedling carbon use efficiency (CUE) across treatments, as the proportion of modelled cumulative net leaf C gain allocated to observed seedling biomass.
