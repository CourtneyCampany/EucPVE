...
4). Last, the growth model was expected to find agreement between observed seedlings mass and mass predicted from a simple C balance model taking into account measured rates of photosynthesis.
