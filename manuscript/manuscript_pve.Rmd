...
\
In partial defoliation experiments, source activity is decreased by reduction of photosynthesizing leaf area. In these experiments, compensatory increases in *A*~n~ of the remaining foliage are commonly found, and have been attributed to several processes including indirect effects on resource availability, such as increaed stomatal conductance [@layne1995end] or enhanced leaf nutrient status [@turnbull2007increased; @pinkard2011gas], or more direct effects of modified sink-source balance such as, reduction in end-product inhibition [@iglesias2002regulation; @zhou2003changes; @handa2005test], enhanced biochemical activity [@ovaska1993b;@layne1995end;@pinkard2011gas], and regulatory sugar signaling [@eyles2013whole]. Similar to elevated CO~2~ experiments, these increases in *A*~n~ in defoliation experiments do not increase tree growth [@palacio2012fast; @markkola2004defoliation; @ovaska1993a]. As these studies do not attempt to scale the degree of compensentory response in leaf C gain to the entire canopy, the overall affect of source manipulation on tree C balance and growth is still unclear. 
