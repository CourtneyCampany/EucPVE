...
where *L* is modelled total plant leaf area (m^2^), *P* is the daily carbon assimilation per unit leaf area (g C m^-2^ d^-1^, explained below), $\sigma$ is a self-shading parameter (explained below), and *R* is the mass based leaf respiration (g C d^-1^). Leaf respiration is included in the calculation of *P*. 
...
*make sure this is correct, add CUE bit *
We then used this model to test the hypothesis that the effects of belowground sink limitation on rates of leaf *A*~n~ were sufficient to accurately predict overall seedling biomass production after 120 days.  Cumulative net leaf C gain for each treatment was equal to the sum of each value of *P* over 120 days and final seedling C was assumed to equal half of the final dry mass for observed seedlings. 
