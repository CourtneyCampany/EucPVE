...
write.csv(Aleaf, "calculated data/Aleaf_model/cday_120_clean_gross.csv", row.names=FALSE)
Aleaf_agg <- summaryBy(carbon_day ~ volume, data=Aleaf, FUN=mean, keep.names=TRUE )
write.csv(Aleaf_agg, "calculated data/Aleaf_model/gCday_means_clean_gross.csv", row.names=FALSE)
